angular.module('kcpr-app', ['ui.router', 'controllers'])
...
.config(function($stateProvider, $urlRouterProvider) {
   ...
   $stateProvider
      ...
      .state('schedule', {
         ...
         resolve: {
            schedule: function($http) {
               return $http.get('https://spreadsheets.google.com/feeds/list/0Ao8Bu17C9mFydFUyWDJXaF9Dams2RFo2XzYxZ3lUTVE/od6/public/values?alt=json')
                  .then(function (data) { 
