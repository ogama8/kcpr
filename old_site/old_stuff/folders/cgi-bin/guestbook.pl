...
$guestbookurl = "http://kcpr.calpoly.edu/music/requests/guestbook.html";
$guestbookreal = "/Web/kcpr/requests/guestbook.html";
$guestlog = "/Web/kcpr/requests/guestlog.html";
$cgiurl = "http://kcpr.calpoly.edu/cgi-bin/guestbook.pl";
